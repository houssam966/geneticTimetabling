public class Input {
    ...
    void initialiseClasses(){
        classes = new Activity[] {
                //MON
                new Activity("11:00:00","12:00:00", "Mon", 1,"Tutorial", "Petr", 0), //HCI 0
                new Activity("11:00:00","13:00:00", "Mon", 1,"Practical", "Amanda",1), //AIP 1
                new Activity("12:00:00","14:00:00", "Mon", -1, "Practical", "Amanda",1), //AIP 2
                new Activity("17:00:00","18:00:00", "Mon", -1,"Tutorial", "Mcburney",2), //AIN 3
                //TUE
                new Activity("09:00:00","11:00:00", "Tue", 1,"Practical", "Petr",0), //HCI 4
                new Activity("11:00:00","12:00:00", "Tue", 1,"Practical", "Mcburney",2), //AIN 5
                new Activity("12:00:00","13:00:00", "Tue", -1,"Practical", "Mcburney",2), //AIN 6
                new Activity("13:00:00","14:00:00", "Tue", -1,"Practical", "Mcburney",2), //AIN 7
                new Activity("15:00:00","16:00:00", "Tue", -1,"Practical", "Mcburney",2), //AIN 8
                new Activity("16:00:00","18:00:00", "Tue", -1,"Practical", "Hannah",3), //VER 9
                //WED
                new Activity("09:00:00","11:00:00", "Wed", 1,"Practical", "Amanda",1), //AIP 10
                new Activity("11:00:00","13:00:00", "Wed", 1,"Practical", "Amanda",1), //AIP 11
                new Activity("11:00:00","13:00:00", "Wed", 1,"Practical", "Petr",0), //HCI 12
                //THU
                new Activity("10:00:00","12:00:00", "Thu", 1,"Practical", "Hannah",3), //VER 13
                //FRI
                new Activity("14:00:00","16:00:00", "Fri", -1,"Practical", "Petr",0), //HCI 14
        };
    }
    ...
    void initialiseStudents(){
        ...
        student1.addAllTimePreferences(new int[]{1,1,1,1,1});
        ...
        students = new Student[]{student0, student1, student2, student3, student4, student5};
    }
}
